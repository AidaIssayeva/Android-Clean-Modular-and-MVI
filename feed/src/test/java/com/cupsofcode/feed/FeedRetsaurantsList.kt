...
val restaurants = listOf<Restaurant>(
    singleRestaurant,
    singleRestaurant.copy(id = 32, name = "Crema", distanceFromUser = 1.1, nextOpenTime = currentTimeInSF.plusHours(3), nextCloseTime = currentTimeInSF.plusHours(5)),
    singleRestaurant.copy(id = 12, name = "My Mexico",  distanceFromUser = 0.25,  nextOpenTime = currentTimeInSF.minusHours(1), nextCloseTime = currentTimeInSF.plusHours(4))
